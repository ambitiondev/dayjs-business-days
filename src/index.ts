...
import { PluginOptions } from "@interfaces/plugin";

// TODO: add typing to dayjsClasss
const dayjsBusinessDays: PluginFunc<PluginOptions> = (
    ...
    dayjsClass.prototype.businessDaysSubtract = function (number: number): Dayjs {
        let currentDay = this.clone();
